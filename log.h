...
void log_errno_provided(enum log_class log_class, const char *module, const char *file, int lineno, int _errno, const char *fmt, ...)
...
void log_errno_provided_va(enum log_class log_class, const char *module, const char *file, int lineno, int _errno, const char *fmt, va_list va)
...
#define LOG_ERRNO_P(_errno, ...) log_errno_provided(LOG_CLASS_ERROR, LOG_MODULE, __FILE__, __LINE__, _errno, __VA_ARGS__)
